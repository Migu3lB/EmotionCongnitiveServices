...
namespace EmotionPlatzi.web.Controllers
{
    public class EmoFacesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,EmoPictureId,Y,X,Width,Height")] EmoFace emoFace)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,EmoPictureId,Y,X,Width,Height")] EmoFace emoFace)
        {
            if (ModelState.IsValid)
            {
